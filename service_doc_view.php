...
?>
<tr>
 <td><a href="service_doc.php?id=<?php echo $row['quote_doc_id'] ?>"><img src="images/icon-edit.png" border="0" /></a></td>
...
<p><a href="service_doc.php?id=0" title="Add New Item"><img src="images/icon-add.png" border="0" alt="Add New Record" /></a>
