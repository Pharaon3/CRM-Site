...
?>
<tr>
 <td><a href="panel_doc.php?id=<?php echo $row['panel_doc_id'] ?>"><img src="images/icon-edit.png" border="0" /></a></td>
 <td><?php echo $row['doc_code'] ?></td>
 <td><?php echo $row['description'] ?></td>
 <td><a href="http://www.solarprimeg.co.za/upload/upload_panel_doc/<?php echo $row['image'] ?>"><?php echo $row['image'] ?></a></td>
...
<p><a href="panel_doc.php?id=0" title="Add New Item"><img src="images/icon-add.png" border="0" alt="Add New Record" /></a>
