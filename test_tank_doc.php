...
if ($_POST){
	$db = new clsDB();
	$db->tableName = "tank_doc";
	$db->primaryField = "tank_doc_id";
    ...
    if(in_array($uploaded_ext, $ext_arr) !== false) {
    	...
    	$target_file = "../upload/upload_tank_doc/$imageValue";
...
<tr>
  <td colspan="4" class="do_b"><table width="16%" border="0" cellspacing="4" cellpadding="4">
    <tr>
      ...
      <th width="92%" align="left" scope="col"><a href="http://solarprimeg.co.za/admin/factory_job_card_tank.php?id=<?php echo $_GET["user"];?>"><img src="images/icon-back.png" alt="" /></a></th>
    </tr>
  </table></td>
  </tr>
    </table>
...
<?php 
$refID = $_GET["id"];
$sql222 = "SELECT * from tank_doc ORDER BY tank_doc_id desc" ;
...
?>
<tr>
 <td><?php echo $row['tank_doc_id'] ?></td>
 <td><?php echo $row['date'] ?></td>
 <td><?php echo $row['description'] ?></td>
 <td><?php echo $row['image'] ?></td>
 <td align="center" class="copy2" style="width:44px !important"><a href="delete_tank.php?delete_tank_doc=<?php echo $row['tank_doc_id']; ?>"><img src="images/icon-delete.png"/></a></td>
