...
$url = "http://solarprimeg.co.za/admin2/select_1.php?id=".$add_id;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right" scope="col"><input type="image" src="images/icon-save5.jpg" /></td>
  </tr>
</table>
...
<table border="0" cellpadding="3" cellspacing="3" width="100%">
    <tr>
        <td colspan="2" bgcolor="#333333" class="do_b">
            <table width="100%" border="0" cellspacing="5" cellpadding="5">
                  <tr>
                    <td align="left" valign="top" class="heading_02" scope="col">CLIENTS DETAILS</td>
                  </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
      ...
      <td class="do_b"><textarea name="txtaddress" class="txt2" required  autocomplete="off"><?php echo $db->getFieldString("address"); ?></textarea></td>
    </tr>
</table>
</fieldset>
<table width="100%">
