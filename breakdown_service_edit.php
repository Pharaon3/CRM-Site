...
$url = "http://www.solarprimeg.co.za/admin2/service_search.php";
...
if ($_POST){
	...
	$db1 = new clsDB();
	$db1->tableName = "job_card";
	$db1->primaryField = "job_id";
	$db1->primaryValue = FormPost("job_id");
	$db1->addparameter("first_name", FormPost("first_name"), "string");
	$db1->addparameter("surname", FormPost("sur_name"), "string");
	$db1->addparameter("cell", FormPost("mobile"), "string");
	$db1->addparameter("email", FormPost("email"), "string");
    $db1->addparameter("address", FormPost("address"), "string");
...
$db1->tableName = "job_card";
$db1->primaryField = "job_id";
$db1->primaryValue = $db->getFieldString("service_job_code");
$db1->loadRecord();
?>
...
<div style="width:100%; border-bottom:thin solid #333; text-align:left; font-size:18px; font-weight:bold; margin-bottom:20px">CLIENT DETAIL</div>
<table border="0" cellpadding="5" cellspacing="5" class="tableadd" width="100%">
<tr>
  <td valign="top" class="do_b"><div style="margin:10px">First Name:</div></td>
  <td colspan="3"><input type="text" style="height:30px" autocomplete="off" name="first_name" class="txt2" id="first_name" value="<?php echo $db1->getFieldString("first_name"); ?>" /></td>
</tr>
<tr>
  <td valign="top" class="do_b"><div style="margin:10px">Surname:</div></td>
  <td colspan="3"><input type="text" style="height:30px" autocomplete="off" name="sur_name" class="txt2" id="sur_name" value="<?php echo $db1->getFieldString("surname"); ?>" /></td>
</tr>
<tr>
  <td valign="top" class="do_b"><div style="margin:10px">Mobile:</div></td>
  <td colspan="3"><input type="text" style="height:30px" autocomplete="off" name="mobile" class="txt2" id="mobile" value="<?php echo $db1->getFieldString("cell"); ?>" /></td>
</tr>
<tr>
  <td valign="top" class="do_b"><div style="margin:10px">Email:</div></td>
  <td colspan="3"><input type="text" style="height:30px" autocomplete="off" name="email" class="txt2" id="email" value="<?php echo $db1->getFieldString("email"); ?>" /></td>
</tr>
<tr>
  <td valign="top" class="do_b"><div style="margin:10px">Address:</div></td>
  <td colspan="3"><textarea name="address" id="address" rows="10" style="width:700px" class="txt2" autocomplete="off"><?php echo $db1->getFieldString("address"); ?></textarea>
  <input type="hidden" name="job_id" value="<?php echo $db->getFieldString("service_job_code"); ?>" />
  </td>
</tr>
</table>
<div style="width:100%; border-bottom:thin solid #333; text-align:left; font-size:18px; font-weight:bold; margin-bottom:20px">BREAKDOWN</div>
