...
$sql20 = "select * from services where  DATE(date_att) BETWEEN DATE('$dateFrom') AND 
DATE('$dateTo') order by next_service desc";
}
...
<form class="form-group" method='post' style="margin-bottom: -5px;">
                  Start Date <input class="form-group" type='date' class='dateFilter' name='dateFrom'>

                  End Date <input class="form-group" type='date' class='dateFilter' name='dateTo'>
