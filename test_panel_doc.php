...
<div style="font-family: Arial; font-size: 13px; font-weight: bold; border-bottom: thin solid #333; padding: 2px; margin: 2px; color: #333; margin-top:20px">UPLOAD PANEL DOCUMENT</div>
<br/>
...
?>
<?php 
$job_number = $_GET["panel_doc_id"];
?>

<table border="0" cellpadding="4" cellspacing="4" class="tableadd" width="100%">
<tr>
  <td width="130" class="do_b">Job Card:</td>
  <td width="292"><span class="do_b">Description:</span></td>
  <td width="291"><span class="do_b">File:</span></td>
  <td width="65" rowspan="2" align="right"></td>
</tr>
<tr>
  <td class="do_b">
    <?php  
	//$link = $_GET["id"];
	//$sql111 = mysqli_query("SELECT * FROM fac_job_panels WHERE id_panels = '$link'") ;
	?>
      <input type="text" name="txtservice_job_code" class="txt2" readonly="readonly" value="<?php echo $_GET["user"];?>" /></td>
...
<table width="16%" border="0" cellspacing="4" cellpadding="4">
  <tr>
    <th width="8%" scope="col"><input type="image" src="images/icon-save.jpg" /></th>
    <th width="92%" align="left" scope="col"><a href="http://solarprimeg.co.za/admin/factory_job_card_panels.php?id=<?php echo $_GET["user"];?>"><img src="images/icon-back.png" /></a></th>
  </tr>
</table>
...
<?php 
$refID = $_GET["id"];
$sql222 = "SELECT * from panel_doc ORDER BY panel_doc_id desc" ;
$r222 = mysqli_query($sql222);
?>
...
?>
<tr>
 <td><?php echo $row['panel_doc_id'] ?></td>
 <td><?php echo $row['date'] ?></td>
 <td><?php echo $row['description'] ?></td>
 <td><?php echo $row['image'] ?></td>
 <td align="center" class="copy2" style="width:44px !important"><a href="delete_panel.php?delete_panel_doc=<?php echo $row['panel_doc_id']; ?>"><img src="images/icon-delete.png"/></a></td>
</tr>
<?php
 }
?>
