...
<tr>
	<td class="do_b" width="121"><div style="margin:10px">Service Job Code:</div></td>
    <td width="561"><input type="text" style="height:30px" autocomplete="off" name="txtservice_job_code" readonly="readonly" class="txt2"  value="<?php echo $_GET["user"]; ?>" /></td>
    <td width="127" align="right"><div style="margin:10px">Service Complete:</div></td>
    <td width="132"><div style="margin:10px">
...
<tr>
  ...
  <td colspan="3"><input type="text" style="height:30px" autocomplete="off" name="txtteam" class="txt2" id="txtteam" value="<?php echo $db->getFieldString("team"); ?>" /></td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="3">
<!--------------------------------------------- Upload document  ----------------------------------------------->
<a href="test_service_doc.php?id=0&user=<?php echo $_GET["user"];?>" style="text-decoration:none" /><div class="upload_btn1">UPLOAD DOCUMENTS</div></a>
  <!--------------------------------- ADD DOCUMENT ----------------------------->
  <?php
