...
<tr>
    ...
    <input type="hidden"  name="imageValue"  value="<?php echo $db->getFieldString('file'); ?>" />
  	...
  	<img src="http://www.solarprimeg.co.za/upload/upload_quote_doc/<?php if($db->getFieldString('image') != "") echo $db->getFieldString('image');else echo "default.jpg"?>" style="width: 100px; height: 100px;" >
    </td>
</tr>
</table>
