...
if (isset($_GET['id'])) {
    ...
    if ($toemailid != ' ') {
        ...
        //$headers .= "cc: munjaldevelopment@gmail.com, jorge@pixelgraphics.co.za, info@pixelgraphics.co.za, admin@solarprimeg.co.za \r\n";
        ...
        $headers1 .= "From: ".$toemailid." \r\n";
        //$headers1 .= "cc: info@pixelgraphics.co.za \r\n";

		$subject = "Services";
		$filename = '2019-Solar-PriMeg-Service-Letter.pdf';
		$path = '/usr/www/users/solarsjkyr/upload';
		$result = mail($to, $subject, $message, $headers1);
    ...
    ?>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#DDDDDD" class="tablelist">
                <tr>
                    ...
                    <td width="285" bgcolor="#E5E5E5" class="do_b">Team:</td>
