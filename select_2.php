...
<div style=" width:800px; margin-left:auto; margin-right:auto">
    ...
    <a href="#" style="text-decoration:none"><div class="but_blk"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;ADD QUOTATION</div></a>
    ...
    <a href="search.php" style="text-decoration:none"><div class="but_blk"><i class="fa fa-check-circle" aria-hidden="true"></i>&nbsp;SEARCH JOB CARD</div></a>
</div>
